        ...
        <div class="content_info">
            ...
            <div class="breadcrumbs breadcrumbs-sections">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('forex') }}">Corporate</a>
                    </li>
                    <li>
                        /
                    </li>
            ...
            <div class="section-title-01 section-title-01-small">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3>Business IRAs</h3>
                            <h5 style="text-transform: none!important;">Create individual retirement accounts to achieve retirement goals.</h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <img src="../img/IRA-savings-416-x-200.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <h4 class="card-title">Simplified Employee Pension IRA</h4>
                                            <p class="card-subtitle text-muted">Simplified Employee Pension (SEP) IRAs provide an easy solution to make contributions to your employees, or your own,  retirement savings.</p>
                                            <div class="card-text" style="margin-bottom:10px;">
                                                <li>Easily establish SEP IRAs for all employees</li>
                                                <li>No minimum contribution limits</li>
                                                <li>Tax benefits for business owners making contributions</li>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card">
                                        <img src="../img/BusinessBillPay_416-x-200.png" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <h4 class="card-title">Savings Incentive Match Plan IRA</h4>
                                            <p class="card-subtitle text-muted">A Savings Incentive Match Plan (SIMPLE) IRA allows eligible employees to contribute part of their pretax compensation to the plan.</p>
                                            <div class="card-text" style="margin-bottom:10px;">
                                                <li> Easily establish SIMPLE IRAs for all employees</li>
                                                <li>Enable employees to make significantly larger annual contributions than possible with a traditional IRA</li>
                                                <li>Significant tax benefits for business owners</li>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title">Payroll Deduction IRA</h4>
                                            <p class="card-subtitle text-muted">Enable your employees to put a portion of their payroll toward their IRA.</p>
                                            <div class="card-text" style="margin-bottom:10px;">
                                                <li>   Easily establish payroll deduction IRAs for all employees</li>
                                                <li>Experience similar contribution limits to standard IRAs</li>
                                                <li>Speed up business operations through automation</li>
                                            </div>
                                        </div>
                                    </div>
                                </div>
