            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h5 style="text-transform: none!important;">Protect and maintain control over your assets so they may be safely transferred to your loved ones.</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="paddings">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h3>As your fiduciary, we are committed to upholding your wishes.</h3>
                        ...
                        <h3>Why Choose Ally Int'l bank?</h3>
